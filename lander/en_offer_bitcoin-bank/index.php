...
$p_lang    = "pent"; // Replace with the language of your offer
$p_country = $_GET['country'] ?? $_SERVER["HTTP_CF_IPCOUNTRY"] ?? "IN"; // Replace with the default country of your offer
...
<section class="intro-section-1" style="padding:15px 0 10px 0">
    ...
    <div class="container"><p class="intro-p"><b data-i18n="warning">Attention</b>: <span data-i18n="due-to">Due to extremely high demand from users, we will close registration starting </span><b><b><span
                            class="tomorrow-date"></span> - <span data-i18n=""><b>Hurry!</b></span> </b></b><span class="countdown-span"
                                                                                                                  id="timer"></span></p>
    </div>
</section>
    ...
    <div class="container">
        <div class="intro-part-2"><img src="images/logo.png" alt="logo" class="logo">
            <div class="exclusive-offers-wrapper intro-margin-div none">
                <div><span class="purple" data-i18n="">EXCLUSIVE OFFER FOR</span><br><span class="red" data-i18n="">BRAZILIAN TRADERS</span><span
                            class="red country-name-geo" data-i18n="">Brazil</span> <span
                            class="red gtd-geo-country-name"></span></div>

                <img data-init="country-flag" height="50" class="flag-pic" src="https://cdnjs.cloudflare.com/ajax/libs/flag-icons/7.2.3/flags/4x3/<?=strtolower($p_country)?>.svg"></div>
            <div class="dynamic-person-div none">
                ...
                <p class="dynamic-person-p"><span class="dynamic-person-name-span userName">Keila N.</span> <span
                            class="userSurname"></span><br><span data-i18n="">just made</span><br><span
...
<section class="video-form-section">
    <div class="container"><h1 class="video-header" data-i18n="">Bitcoin is making people rich</h1>
        <p class="video-subheader"><span data-i18n="">And you could become the</span> <span class="yellow" data-i18n="">Next millionaire...</span>
        </p>
        ...
        <div class="intro-part-2">
            <div class="exclusive-offers-wrapper intro-margin-div" style="">
                <div class="exclusive-offers-text"><span class="purple"
                                                         data-i18n="">EXCLUSIVE OFFER FOR</span><br><span class="red"
                                                                                                          data-i18n="">BRAZILIAN TRADERS</span><span
            ...
            <div class="dynamic-person-div">
                ...
                <p class="dynamic-person-p"><span class="dynamic-person-name-span">Keila N.</span><br><span
                            data-i18n="">just made</span><br><span class="dynamic-person-sum-span">479</span> <span
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-8"><h1 class="join-us-header"><span
                            data-i18n="">Join us and start Making Money </span><span style="color:#5f3394"
                                                                                     data-i18n="">with Bitcoin Bank!</span>
                </h1><br>
                <p class="join-us-p"><span data-i18n="">Bitcoin Bank is a group exclusively reserved for people who have jumped into the insane returns that Bitcoin offers and have silently accumulated a fortune. Our members enjoy traveling around the world every month while making money on their laptop with just a few minutes of “work” per day.</span>
                </p></div>
        </div>
    </div>
</section>
...
<section class="fake-news-section">
    <div class="container">
        <div class="row fake-news-section_row">
            <div class="col-md-5"><p class="seenon-p" data-i18n="">As seen on</p>
...
<section class="testimonials-section">
    <div class="container-fluid"><h4 class="testimonials-header purple" data-i18n="">Real testimonials from our
            users</h4>
        <div class="row">
            <div class="col-md-6 col-sm-12 col-lg-3 no-padding">
                <div class="testimonial-wrapper testimonial-wrapper-1">
                    <div class="testimonial-intro-text white"><span data-i18n="">Marcos C.</span><br><span data-i18n="">Belo Horizonte</span><br><span
                                class="yellow testimonial-profit-span"><span data-i18n="">Profit</span>: <span
                                    data-init="visitor-currency-symbol"><span class="currency">$</span></span>12,853</span>
                    </div>
                    <div class="testimonial-hover-text"><i>"I’ve been a member of the 'Bitcoin Revolution' for only 47 days.
                            But my life has already changed! Not only did I make my first <span class="currency">$</span> 10K, but
                            I’ve also met some incredible people in the process. Thank you, Bitcoin Bank!"</i></div>
                </div>
            </div>
            <div class="col-md-6 col-sm-12 col-lg-3 no-padding">
                <div class="testimonial-wrapper testimonial-wrapper-2">
                    ...
                    <div class="testimonial-hover-text"><i>"I finally know what it feels like to live the dream. I no longer feel like I’m on the outside looking in while everyone else is having fun. Bitcoin Bank allowed me to retire early and live a lifestyle that only 1% of the population has."</i></div>
                </div>
            </div>
            <div class="col-md-6 col-sm-12 col-lg-3 no-padding">
                <div class="testimonial-wrapper testimonial-wrapper-3">
                    <div class="testimonial-intro-text white"><span data-i18n="">Matheus I.</span><br><span
                                data-i18n="">Salvador</span><br><span class="yellow testimonial-profit-span"><span
                                    data-i18n="">Profit</span>: <span data-init="visitor-currency-symbol"><span class="currency">$</span></span>10519</span>
                    </div>
                    <div class="testimonial-hover-text"><i>"In 10 years of investing in the stock market, I’ve never seen anything like this. Everyone at work thought I was crazy when I quit the company to invest full-time with the Bitcoin Bank software. <span class="currency">$</span> 38,459 in profits later, all my coworkers are now BEGGING me to let them join."</i></div>
                </div>
            </div>
            <div class="col-md-6 col-sm-12 col-lg-3 no-padding">
                <div class="testimonial-wrapper testimonial-wrapper-4">
                    ...
                    <div class="testimonial-hover-text"><i>"Two weeks ago, I was laid off. With no options and this whole crisis, I thought my life was over. Now I’m earning more than R$ 1,261.42 every day. And for the first time in 2 months, my account isn’t in the red. Thank you, Bitcoin Bank!"</i></div>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="col-lg-4 feature-wrapper-col">
                <div class="feature-wrapper">
                    <div class="feature-img-wrapper"><img src="images/feature-img-1.png" class="feature-img"
                                                          alt="feature 1"></div>
                    <h5 class="feature-header" data-i18n="">LASER-PRECISION PERFORMANCE</h5>
                    <p class="feature-description" data-i18n="">There is no other trading application in the world that achieves a 99.4% accuracy level like Bitcoin Bank. That's why our members from all over the world trust us to double, triple, and quadruple their hard-earned money.</p>
                </div>
            </div>
            <div class="col-lg-4 feature-wrapper-col">
                <div class="feature-wrapper">
                    <div class="feature-img-wrapper"><img src="images/feature-img-2.png" class="feature-img"
                                                          alt="feature 1"></div>
                    <h5 class="feature-header" data-i18n="">CUTTING-EDGE TECHNOLOGY</h5>
                    <p class="feature-description" data-i18n="">Bitcoin Bank software was created using the most advanced programming the commercial world has ever seen. The software is ahead of the markets by 0.01 seconds. This 'time leap' makes it the most consistent trading app on the planet.</p>
                </div>
            </div>
            <div class="col-lg-4 feature-wrapper-col">
                <div class="feature-wrapper feature-wrapper_small">
                    ...
                    <p class="feature-description" data-i18n="">The Bitcoin Bank app has won several awards. The most recent award we've been honored with is ranking first in the trading software category of the US Trading Association.</p>
                </div>
            </div>
        </div>
    </div>
...
<section class="live-results-section">
    <div class="container relative">
        <div class="live-results-table-wrapper">
            <button class="yellow-btn join-now-btn scroll-top-btn"><span data-i18n="">JOIN NOW!</span></button>
            <h1 class="dark-purple bold live-results-header text-center" data-i18n="">Live Profit Results!</h1>
...
<section class="how-it-works-section text-center">
    <div class="container">
        <div class="how-it-works-wrapper"><h1 class="dark-purple bold how-it-works-header" data-i18n="">How it works</h1>
            <div class="row">
                <div class="col-md-4 no-padding step-wrapper-col">
                    <div class="step-wrapper step-wrapper-1"><h3 class="step-header white step-header-1" data-i18n="">
                        ...
                        <div class="step-description"><h5 class="step-subheader bold dark-purple" data-i18n="">
                                Register on the site</h5>
                            <p class="card-text" data-i18n="">Once your registration is accepted, you will automatically become the newest member of Bitcoin Bank. And you will gain access to our own bitcoin trading software for free.</p></div>
                    </div>
                </div>
                <div class="col-md-4 no-padding step-wrapper-col">
                    <div class="step-wrapper step-wrapper-2"><h3 class="step-header white step-header-2" data-i18n="">
                        ...
                        <div class="step-description"><h5 class="step-subheader bold dark-purple" data-i18n="">Fund your account</h5>
                            <p><span data-i18n="" class="card-text">Like any business, you need working capital to get started. So, to start profiting with Bitcoin Bank, you need to invest any amount you wish from R$ 800.00 or more.</span>
                            </p></div>
                    </div>
                </div>
                <div class="col-md-4 no-padding step-wrapper-col">
                    <div class="step-wrapper last-step-wrapper step-wrapper-3"><h3
                                class="step-header white step-header-3" data-i18n="">Step 3</h3>
                        <div class="step-img-wrapper"><img src="images/step-img-3.png" alt="step 3" class="step-img">
                        </div>
                        <div class="step-description"><h5 class="step-subheader bold dark-purple" data-i18n="">
                                Finish</h5>
                            <p data-i18n="" class="card-text">Click on trade to enjoy the precise award-winning and most importantly, automatic trading software. You can also set the trading to manual if you prefer to trade on your own.</p></div>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="how-it-works-btn-wrapper">
        <button class="yellow-btn open-free-account-btn scroll-top-btn"><span data-i18n="">Open a free account</span>
        </button>
    </div>
</section>

<section class="faq-section">
    <div class="container"><h2 class="faq-section-header text-center dark-purple bold" data-i18n="">Frequently Asked Questions</h2>
        <div class="row">
            <div class="col-lg-6">
                <div class="row">
                    <div class="col-lg-11">
                        <div class="faq-wrapper faq-wrapper-1"><h4 class="faq-question light-purple bold" data-i18n="">
                                What kind of results can I expect?</h4>
                            <p class="faq-answer">Members typically profit a minimum of daily.</p></div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-lg-11">
                        <div class="faq-wrapper faq-wrapper-2"><h4 class="faq-question light-purple bold" data-i18n="">
                                How many hours a day do I need to work?</h4>
                            <p class="faq-answer" data-i18n="">Our members work an average of 20 minutes per day or less. Since the software handles the trading, the amount of 'work' required is minimal.</p></div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-lg-11">
                        <div class="faq-wrapper faq-wrapper-3"><h4 class="faq-question light-purple bold" data-i18n="">
                                What is the maximum amount I can make?</h4>
                            <p class="faq-answer" data-i18n="">Your profits are unlimited with The Bitcoin Bank. Some members earned their first million in just 61 days.</p></div>
                    </div>
                </div>
            </div>
            <div class="col-lg-6">
                <div class="row">
                    <div class="col-lg-11">
                        <div class="faq-wrapper faq-wrapper-4"><h4 class="faq-question light-purple bold" data-i18n="">
                                How much does the software cost?</h4>
                            <p class="faq-answer" data-i18n="">Members of The Bitcoin Bank receive a copy of our proprietary software for free. To become a member, just fill out the form on this page.</p></div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-lg-11">
                        <div class="faq-wrapper faq-wrapper-5"><h4 class="faq-question light-purple bold" data-i18n="">
                                Is it like MLM, multi-level marketing, a pyramid scheme, or affiliate marketing?</h4>
                            <p class="faq-answer" data-i18n="">This is not like MLM, affiliate marketing, or anything else out there. The software beats trades with 99.4% accuracy.</p></div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-lg-11">
                        <div class="faq-wrapper faq-wrapper-6"><h4 class="faq-question light-purple bold" data-i18n="">
                                Are there any fees?</h4>
                            <p class="faq-answer" data-i18n="">There are no hidden fees. No brokerage fees or commissions. All your money is 100% yours and you are free to withdraw it at any time you choose without delay.</p></div>
                    </div>
                </div>
            </div>
        </div>
...
<section class="pre-footer-section">
    <div class="container">
        <button class="pre-footer-btn scroll-top-btn">Start Now</button>
    </div>
</section>
...
<footer class="footer text-center">
    <div class="container">
        <ul class="footer-ul">
            <li><a id="privacy-policy" href="#form">PRIVACY</a></li>
            <li><a id="terms" href="#form">TERMS</a></li>
            <li><a id="earnings-disclaimer" href="#form">DISCLAIMER</a></li>
            <li><a id="report-abuse" hhref="#form" style="text-transform:uppercase">Report&nbsp;Abuse&nbsp;/&nbsp;Spam</a>
            </li>
        </ul>
        <div id="disclaimerAndText"
            ...
            IMPORTANT: Earnings and Legal Disclaimers Earnings and income representations made by <span
                    class="disclaimer-brand_name__new">bl.bitcbanksprofit.com</span>, (collectively “This Website”) are used only
            as aspirational examples of your earnings potential. The success of those in the testimonials and other
            examples are exceptional results and are therefore not intended as a guarantee that you or others will
            ...
            involves the risk of partial/full loss of invested capital. Therefore, you should consider whether you
            can afford to invest. ©<span id="yearDisclaimerNew">2023</span><br>USA REGULATION NOTICE: Trading Forex,
            CFDs, and Cryptocurrencies is not regulated within the United States. Investing in Crypto is not supervised or
            regulated by any financial agencies, including U.S. agencies. Any unregulated trading activity by U.S. residents is
            considered unlawful. This Website does not accept customers located within the United States or holding an
            American citizenship. This Website is not responsible for the actions of customers located within the United
            ...
            this Website. In all circumstances, the choice to use the Website, the Service, and/or the Software is
            under the full responsibility of the User, who should comply with current legislation.
        </div>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header"><h5 class="modal-title" id="congratulationsLabel" data-i18n="congratulations">
                    Congratulations</h5>
                <p data-i18n="recommended-broker">Recommended Broker</p></div>
            <div class="modal-body">
                ...
                <div class="modal-priority"><h4><i class="brshield"></i> <a data-i18n="your-safety">YOUR SAFETY IS OUR PRIORITY</a></h4>
                    <p><a data-i18n="as-determined">As determined by your regulatory statute, </a><span
                                data-init="broker-name" class="broker-name"></span> <a data-i18n="take-strict-measures">takes strict measures to safeguard client funds and your privacy.</a></p></div>
                <div class="inner">&nbsp;</div>
                <div class="modal-priority"><h4><i class="brmoney"></i><a data-i18n="high-payout">HIGH PAYOUT OPTIONS</a></h4>
                    <p><span data-init="broker-name" class="broker-name"></span> <a data-i18n="offers-return">offers up to 88% profit per successful trade!</a></p></div>
            </div>
            <div class="modal-footer"><a style="text-decoration:none" class="btn-send-thanks">
                    <button data-init="broker-url" type="button" class="btn broker-url" data-i18n="start-trading">Start Trading Now
                    </button>
                </a></div>
        </div>
    </div>
