...
$text->tahnks_for = 'Thank you for <br> registration';
$text->tahnks_broker = 'Our trusted broker will contact you shortly by phone. He will explain all the details and offer you our special bonus.';
$text->thanks_go_to_broker = "Go To Broker Site";
$text->thanks_respond_time = "2 Hours";
$text->thanks_respond_time_avarage = "Average response time";
$text->contact_you = "We Will contact you shortly";
