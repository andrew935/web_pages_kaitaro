...
function EventBusService(){this._subscriptions={},this._id=0}console.log("Funnels SDK: v6.1.8"),EventBusService.prototype.on=function(e,t){var i=this._getIdGenerator();this._subscriptions[e]||(this._subscriptions[e]={}),this._subscriptions[e][i]=t},EventBusService.prototype.emit=function(e,t){if(this._subscriptions[e])for(var i in this._subscriptions[e])this._subscriptions[e].hasOwnProperty(i)&&this._subscriptions[e][i](t)},EventBusService.prototype._getIdGenerator=function(){return this._id+=1,this._id};var $eventBusService=new EventBusService;function StoreService(){this._prefix="f1t:v6:"}StoreService.prototype.set=function(e,t){store.set(this._prefix+e,JSON.stringify(t))},StoreService.prototype.get=function(e){var t;try{t=JSON.parse(store.get(this._prefix+e))}catch(e){}return t},StoreService.prototype.remove=function(e){store.remove(this._prefix+e)};var $storeService=new StoreService;function UtilitiesService(){this._isReady=!1,this.setData(),this._initPolyfills()}UtilitiesService.prototype.doWhenIsReady=function(e){this._isReady?e():$eventBusService.on("utilitiesService:ready",e)},UtilitiesService.prototype.http=function(t,i,r,a,e){var n=this.getData(),o="";n&&n.secret&&(o=n.secret);try{var l=new(XMLHttpRequest||ActiveXObject)("MSXML2.XMLHTTP.3.0");l.open(t,i,!0),l.setRequestHeader("X-Requested-With","XMLHttpRequest"),l.setRequestHeader("Authorization",o||""),l.onreadystatechange=function(){4===l.readyState&&200===l.status?r(l.responseText):3<l.readyState&&(e&&e(l),window.console&&console.error(n,t,i,r,a,l))},l.send(a)}catch(e){window.console&&console.error(n,t,i,r,a,l,e),Sentry&&Sentry.captureException(e)}},UtilitiesService.prototype.getParameterByName=function(e,t){var i=new Url;return t&&(i=new Url(t)),i.query[e]},UtilitiesService.prototype.urlEncode=function(e){return(new Url).encode(e)},UtilitiesService.prototype.removeParameterByName=function(e,t){var i=new Url;t&&(i=new Url(t)),delete i.query[e];try{history.pushState({},null,i.toString())}catch(e){}},UtilitiesService.prototype.domReady=function(e){"loading"!==document.readyState?e():document.addEventListener("DOMContentLoaded",e)},UtilitiesService.prototype.getData=function(){var e;try{e=JSON.parse(atob($storeService.get("d")))}catch(e){}return e},UtilitiesService.prototype.randPassword=function(e,t,i){for(var r=["abcdefghijklmnopqrstuvwxyz","0123456789","ABCDEFGHIJKLMNOPQRSTUVWXYZ"],a=[],n=0;n<e;n++)a.push(r[0][Math.floor(Math.random()*r[0].length)]);for(n=0;n<t;n++)a.push(r[1][Math.floor(Math.random()*r[1].length)]);for(n=0;n<i;n++)a.push(r[2][Math.floor(Math.random()*r[2].length)]);return a=a.sort(function(){return.5-Math.random()}).join("")},UtilitiesService.prototype.setData=function(e){var t;e?t=e:this.getParameterByName("d")?t=this.getParameterByName("d"):$storeService.get("d")&&(t=$storeService.get("d")),$storeService.set("d",t),this.getData()&&(this._isReady=!0,$eventBusService.emit("utilitiesService:ready"))},UtilitiesService.prototype.domTools={closest:function(e,t){for(;(e=e.parentElement)&&!e.classList.contains(t););return e},on:function(e,t,l,s){var c=document.querySelector(e);c.addEventListener(t,function(e){for(var t=c.querySelectorAll(l),i=e.target,r=0,a=t.length;r<a;r++)for(var n=i,o=t[r];n&&n!==c;){if(n===o)return s.call(o,e);n=n.parentNode}})}},UtilitiesService.prototype._initPolyfills=function(){Element.prototype.matches||(Element.prototype.matches=Element.prototype.msMatchesSelector||Element.prototype.webkitMatchesSelector),Element.prototype.closest||(Element.prototype.closest=function(e){var t=this;do{if(Element.prototype.matches.call(t,e))return t;t=t.parentElement||t.parentNode}while(null!==t&&1===t.nodeType);return null}),"remove"in Element.prototype||(Element.prototype.remove=function(){this.parentNode&&this.parentNode.removeChild(this)}),function(){if("function"==typeof window.CustomEvent)return;window.CustomEvent=function(e,t){t=t||{bubbles:!1,cancelable:!1,detail:null};var i=document.createEvent("CustomEvent");return i.initCustomEvent(e,t.bubbles,t.cancelable,t.detail),i}}()};var $utilitiesService=new UtilitiesService;function KeyCheckerService(){this._logs=[],this._init()}KeyCheckerService.prototype._init=function(){var r=this;document.addEventListener("keydown",function(e){if(r._checkIgnoreKey(e.key)){var t=dayjs(),i=r._logs[r._logs.length-1];i?t-i.date<2e3?r._write(r._logs.length-1,t,e.key):t-i.date<5e3?r._write(r._logs.length-1,t,"; "+e.key):r._add(t,e.key):r._add(t,e.key)}})},KeyCheckerService.prototype.getLogsJson=function(){for(var e=[],t=0;t<this._logs.length;t++)e.push(this._logs[t].log);return JSON.stringify(e)},KeyCheckerService.prototype._checkIgnoreKey=function(e){switch(e){case"Tab":var t=dayjs();this._add(t,"")}switch(e){case"Tab":case"Shift":case"Backspace":case"Control":return!1;default:return!0}},KeyCheckerService.prototype._write=function(e,t,i){this._logs[e]={date:t,log:this._logs[e].log+i}},KeyCheckerService.prototype._add=function(e,t){this._logs.push({date:e,log:t})};var $keyCheckerService=new KeyCheckerService;function ConfigService(){this._init()}ConfigService.prototype._init=function(){window.F1TFunnelsSdkConfig||(window.F1TFunnelsSdkConfig={}),this._loadLanguages()},ConfigService.prototype._loadLanguages=function(){var t=this,e=document.querySelector('[data-type="F1TFunnelSdkJs"]').getAttribute("src").replace("js/main.min.js","i18n/"+this.language()+".json");$utilitiesService.http("GET",e,function(e){$translateService.setTranslations(JSON.parse(e))},null,function(e){"en"!==window.F1TFunnelsSdkConfig.language&&(window.F1TFunnelsSdkConfig.language="en",t._loadLanguages())})},ConfigService.prototype.localSuffix=function(){return atob("LnBsYXRmb3JtNTAwLmNvbS9iYWNrZW5k")},ConfigService.prototype.language=function(){return window.F1TFunnelsSdkConfig.language||"en"},ConfigService.prototype.initUrl=function(){return $utilitiesService.getParameterByName("ts_id")?"/api/v1/leads-workflow/initWithTS/"+$utilitiesService.getParameterByName("tp_id")+"/"+$utilitiesService.getParameterByName("funnel_id"):"/api/v1/leads-workflow/init/"+$utilitiesService.getParameterByName("tp_id")+"/"+$utilitiesService.getParameterByName("funnel_id")},ConfigService.prototype.isAvailableInit=function(){return!(!$utilitiesService.getParameterByName("tp_id")||!$utilitiesService.getParameterByName("funnel_id"))},ConfigService.prototype.localApi=function(){return void 0===window.F1TFunnelsSdkConfig.localApi||window.F1TFunnelsSdkConfig.localApi},ConfigService.prototype.apiUrl=function(){var e=$utilitiesService.getData(),t="";return this.localApi()||(e?t="https://"+e.api+this.localSuffix():$utilitiesService.getParameterByName("ld_id")&&(t="https://"+$utilitiesService.getParameterByName("ld_id")+this.localSuffix())),t},ConfigService.prototype.apiDomain=function(){var e=$utilitiesService.getData();return $utilitiesService.getParameterByName("ld_id")?$utilitiesService.getParameterByName("ld_id"):e?e.api:$utilitiesService.getParameterByName("ld_id")},ConfigService.prototype.encodedParams=function(){var e=$utilitiesService.getData();return $utilitiesService.getParameterByName("e")?$utilitiesService.getParameterByName("e"):e?e.e:$utilitiesService.getParameterByName("e")},ConfigService.prototype.checkConfig=function(){var e=new Url;$storeService.get("funnelUrl"),e.toString();return!1};var $configService=new ConfigService;function GeoService(){this._isReady=!1,this._geo={},this._init()}GeoService.prototype.doWhenIsReady=function(e){this._isReady?e():$eventBusService.on("geoService:ready",e)},GeoService.prototype.isReady=function(){return this._isReady},GeoService.prototype.geo=function(){return this._geo},GeoService.prototype._init=function(){var t=this;$utilitiesService.http("GET",$configService.apiUrl()+"/api/v1/leads-workflow/info/geo?e="+$configService.encodedParams()+"&ld_id="+$configService.apiDomain(),function(e){t._geo=JSON.parse(e).data[0],t._isReady=!0,$eventBusService.emit("geoService:ready")})};var $geoService=new GeoService;function TranslateService(){this._translations={},this._isReady=!1}function OfferUtilitiesService(){this._init()}TranslateService.prototype.doWhenIsReady=function(e){this._isReady?e():$eventBusService.on("translateService:ready",e)},TranslateService.prototype.isReady=function(){return this._isReady},TranslateService.prototype.setTranslations=function(e){this._translations=e,this._isReady=!0,$eventBusService.emit("translateService:ready")},TranslateService.prototype.t=function(e,t){var i=$configService.language(),r="";if(this._translations[i]||(i="en"),this._translations[i][e])r=this._translations[i][e];else{if(!this._translations.en[e])return e;r=this._translations.en[e]}for(var a in t)t.hasOwnProperty(a)&&(r=r.replace("{{"+a+"}}",t[a]));return r},$translateService=new TranslateService,OfferUtilitiesService.prototype._init=function(){var e=this;$utilitiesService.domReady(function(){e._initDateFields(),e._initGeo(),e._initEvents()})},OfferUtilitiesService.prototype._initDateFields=function(){for(var e=dayjs(),t=document.querySelectorAll(".f1t-date-current-date"),i=0;i<t.length;i++)t[i].innerHTML=e.format("dddd, MMMM DD, YYYY")},OfferUtilitiesService.prototype._initGeo=function(){$geoService.doWhenIsReady(function(){for(var e=document.querySelectorAll(".f1t-geo-country-name"),t=0;t<e.length;t++)e[t].innerHTML=String($geoService.geo().country);var i=document.querySelectorAll(".f1t-geo-country-flag-icon");for(t=0;t<i.length;t++)i[t].classList.add("flag-icon"),i[t].classList.add("flag-icon-"+String($geoService.geo().iso_code).toLowerCase());try{var r=document.querySelectorAll(".f1t-geo-replacer");for(t=0;t<r.length;t++){var a=r[t].dataset.attributeKey,n=r[t].dataset.attributeValue;n=n.replace("{language}",$geoService.geo().language),r[t].setAttribute(a,n)}}catch(e){console.error("Geo Replacer Error: ",e)}})},OfferUtilitiesService.prototype._initEvents=function(){$geoService.doWhenIsReady(function(){var e=new CustomEvent("geoService:ready",{detail:{geo:$geoService.geo()}});document.body.dispatchEvent(e)})};var $offerUtilitiesService=new OfferUtilitiesService;function ValidatorService(e,t){this._object=e,this._rules=t,this._errors={}}function LoadingCommand(){this._formSelector=".f1t-form",this._init()}function VerificationCommand(e){this._formSelector=".f1t-form",this._init(e)}function VerificationFailCommand(){this._init()}function FormCommand(e){this._config=e,this._formSelector=".f1t-form",this._formFields=[],this._rules={},this._init()}function FormFieldModel(e,t,i,r,a,n){this.type=e,this.label=t,this.key=i,this.placeholder=r,this.value=a,this.validationRules=n}function FormValidationErrorsCommand(e,t){this._config=e,this._formEl=t,this._init()}function ResetCommand(){$storeService.remove("d")}function RedirectCommand(e){this._config=e,this._init()}function TrafficFilterCommand(){this._init()}function PixelCommand(e,t){this._config=e,this._callback=t,this._availablePixelTypes={inlineIframeUrl:"inline",inlineImgUrl:"inline-img",inlineScriptUrl:"inline-script",externalIframeUrl:"script",externalScriptUrl:"script-script",bodyHtmlInsert:"html",scriptEvaluate:"html-eval",externalSandboxIframeUrl:"script-sandboxed",inlineSandboxIframeUrl:"inline-sandboxed"},this._init()}function PrePushPixelsCommand(e){this._config=e,this._init()}function AdvAcceptedCommand(e){this._config=e,this._init()}function AdvAcceptedHtmlCommand(e){this._config=e,this._init()}function AdvAcceptedPasswordCommand(e){this._config=e,this._init()}function AutoRedirectModal(e){this._config=e,this._init()}function AdvDeclinedCommand(){this._init()}function ThankYouCommand(e){this._config=e,this._init()}function ThankYouRedirectCommand(e){this._config=e,this._init()}function WorkflowService(){this._init(),this.skipFutureCommands=!1}ValidatorService.prototype.validate=function(){var e=!0;for(var t in this._errors={},this._object)if(this._object.hasOwnProperty(t)&&this._rules.hasOwnProperty(t)){var i=this._check(this._object[t],this._rules[t]);0<i.length&&(this._errors[t]=i,e=!1)}return e},ValidatorService.prototype.errors=function(){return this._errors},ValidatorService.prototype._check=function(e,t){for(var i=[],r=[],a=t.split("|"),n=0;n<a.length;n++)a[n].split(":")[1]?r.push({type:a[n].split(":")[0],argument:a[n].split(":")[1]}):r.push({type:a[n].split(":")[0]});for(n=0;n<r.length;n++)switch(r[n].type){case"required":e||i.push("The field is required.");break;case"min":e.length<=r[n].argument&&i.push("The field must contain more characters.");break;case"max":e.length>r[n].argument&&i.push("The field must contain fewer characters.");break;case"email":/^(([^<>()[\]\\.,;:\s@"]+(\.[^<>()[\]\\.,;:\s@"]+)*)|(".+"))@((\[[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\])|(([a-zA-Z\-0-9]+\.)+[a-zA-Z]{2,}))$/.test(String(e).toLowerCase())||i.push("The email format is invalid.")}return i},LoadingCommand.prototype._init=function(){var e=this;$utilitiesService.domReady(function(){e._render()})},LoadingCommand.prototype._render=function(){for(var e=document.querySelectorAll(this._formSelector),t=0;t<e.length;t++)e[t].innerHTML='<div class="f1t-loading"></div>'},VerificationCommand.prototype._init=function(e){var t=this;$utilitiesService.domReady(function(){$translateService.doWhenIsReady(function(){t._render(e)})})},VerificationCommand.prototype._render=function(e){this._beforeRender();for(var t=document.querySelectorAll(this._formSelector),i=0;i<t.length;i++){t[i].innerHTML='            <form class="f1t-form__wrapper">                <div class="f1t-form__inner"></div>                <div class="f1t-form__footer">                    <button class="f1t-form__submit" type="submit">Submit</button>                </div>            </form>        ';var r=t[i].querySelector(".f1t-form__inner"),a=document.createElement("div");a.classList.add("f1t-form__row");var n=document.createElement("div");n.classList.add("f1t-form-field"),n.innerHTML='                <label>                    <div class="f1t-form-field__label">Enter Code</div>                    <input type="text" placeholder="Enter Code" name="code" value="">                </label>            ',a.appendChild(n),r.appendChild(a),this._appendOnSubmit(t[i])}},VerificationCommand.prototype._appendOnSubmit=function(s){var c=this,d=$utilitiesService.getData();s.querySelector(".f1t-form__wrapper").addEventListener("submit",function(e){e.preventDefault();for(var t=document.querySelectorAll(".f1t-form.is-submited"),i=0;i<t.length;i++)t[i].classList.remove("is-submited");s.classList.add("is-submited");var r=new FormData(e.target),a={},n=s.querySelectorAll("input, select, textarea");for(i=0;i<n.length;i++)a[n[i].getAttribute("name")]=n[i].value;if(!s.classList.contains("f1t-form--loading"))if(s.classList.add("f1t-form--loading"),d){try{var o=$keyCheckerService.getLogsJson();r.set("logs",o)}catch(e){}var l=$configService.apiUrl()+"/api/v1/leads-workflow/forms/handle?e="+$configService.encodedParams()+"&ld_id="+$configService.apiDomain()+"&id="+$utilitiesService.getData().id;$utilitiesService.http("POST",l,function(e){var t;try{t=JSON.parse(e).data}catch(e){t={commands:[{type:"loading"}]}}$workflowService.onState(t,s)},r)}else setTimeout(function(){c._afterSubmitForm(s)},500)})},VerificationCommand.prototype._beforeRender=function(){for(var e=document.querySelectorAll(this._formSelector),t=0;t<e.length;t++)e[t].classList.remove("f1t-form--loading"),e[t].classList.remove("is-submited")},VerificationFailCommand.prototype._init=function(){var e=this;$utilitiesService.domReady(function(){$translateService.doWhenIsReady(function(){e._render()})})},VerificationFailCommand.prototype._render=function(){var e=document.createElement("div");e.classList.add("f1t-modal"),e.classList.add("f1t-modal--small"),e.classList.add("f1t-modal--error"),e.innerHTML='      <div class="f1t-modal__wrapper">        <div class="f1t-modal__inner">          <div class="f1t-modal__header">            <div class="f1t-modal__image f1t-modal__image--error"></div>            <div class="f1t-modal__title">'+$translateService.t("PHONE_VERIFICATION_ERROR")+'</div>          </div>          <div class="f1t-modal__footer">                  <div class="f1t-modal__button js-try-again">'+$translateService.t("TRY_AGAIN")+"</div>                   </div>        </div>      </div>    ",document.body.appendChild(e),this._afterRender()},VerificationFailCommand.prototype._afterRender=function(){for(var t=this,e=document.querySelectorAll(".js-try-again"),i=0;i<e.length;i++)e[i].addEventListener("click",function(e){e.preventDefault(),t._reInit()})},VerificationFailCommand.prototype._reInit=function(){$workflowService.reInitForm()},FormCommand.prototype._init=function(){for(var e=this,t=0;t<this._config.fields.length;t++){var i=this._config.fields[t].validation_rules.trim();0<i.length&&(this._rules[this._config.fields[t].key]=i),this._formFields.push(new FormFieldModel(this._config.fields[t].type,this._config.fields[t].label,this._config.fields[t].key,this._config.fields[t].placeholder,this._config.fields[t].value,i))}$utilitiesService.domReady(function(){$translateService.doWhenIsReady(function(){e._render()})})},FormCommand.prototype._render=function(){this._beforeRender();for(var e=document.querySelectorAll(this._formSelector),t=0;t<e.length;t++){e[t].innerHTML='            <form class="f1t-form__wrapper">                <div class="f1t-form__inner"></div>                <div class="f1t-form__footer">                    <button class="f1t-form__submit" type="submit">'+this._config.submit+"</button>                </div>            </form>        ";var i=e[t].querySelector(".f1t-form__inner");this._renderForm(i),this._appendOnSubmit(e[t])}this._afterRenderForms()},FormCommand.prototype._beforeRender=function(){for(var e=document.querySelectorAll(this._formSelector),t=0;t<e.length;t++)e[t].classList.remove("f1t-form--loading"),e[t].classList.remove("is-submited")},FormCommand.prototype._appendOnSubmit=function(d){var f=this,m=$utilitiesService.getData();d.querySelector(".f1t-form__wrapper").addEventListener("submit",function(e){e.preventDefault();for(var t=document.querySelectorAll(".f1t-form.is-submited"),i=0;i<t.length;i++)t[i].classList.remove("is-submited");d.classList.add("is-submited"),f._beforeSubmitForm(d);var r=new FormData(e.target),a={},n=d.querySelectorAll("input, select, textarea");for(i=0;i<n.length;i++)for(var o=0;o<f._formFields.length;o++)n[i].getAttribute("name")===f._formFields[o].key&&(a[f._formFields[o].key]=n[i].value);var l=new ValidatorService(a,f._rules);if(l.validate()){if(!d.classList.contains("f1t-form--loading"))if(d.classList.add("f1t-form--loading"),m){try{var s=$keyCheckerService.getLogsJson();r.set("logs",s)}catch(e){}var c=$configService.apiUrl()+"/api/v1/leads-workflow/forms/handle?e="+$configService.encodedParams()+"&ld_id="+$configService.apiDomain()+"&id="+$utilitiesService.getData().id;$utilitiesService.http("POST",c,function(e){var t;try{t=JSON.parse(e).data}catch(e){t={commands:[{type:"loading"}]}}$workflowService.onState(t,d)},r)}else setTimeout(function(){f._afterSubmitForm(d)},500)}else f._renderErrors(d,l.errors())})},FormCommand.prototype._renderErrors=function(e,t){for(var i in t){var r=e.querySelector("[name="+i+"]").closest(".f1t-form-field");if(r){r.classList.add("f1t-form-field--error");var a=document.createElement("div");if(a.classList.add("f1t-form-field__error"),t.hasOwnProperty(i))for(var n=0;n<t[i].length;n++){var o=r.querySelector(".f1t-form-field__label"),l=t[i][n].replace(" "+String(o.innerHTML).toLowerCase(),"");a.innerHTML+=$translateService.t(l),n<t[i].length&&(a.innerHTML+=" ")}r.appendChild(a)}}},FormCommand.prototype._afterSubmitForm=function(e){e.classList.remove("f1t-form--loading")},FormCommand.prototype._beforeSubmitForm=function(e){for(var t=e.querySelectorAll(".f1t-form-field--error"),i=0;i<t.length;i++)t[i].classList.remove("f1t-form-field--error");var r=e.querySelectorAll(".f1t-form-field__error");for(i=0;i<r.length;i++)r[i].remove()},FormCommand.prototype._renderForm=function(e){for(var t=0;t<this._formFields.length;t++)this._renderFormField(e,this._formFields[t])},FormCommand.prototype._afterRenderForms=function(){for(var i=document.querySelectorAll(".f1t-form-field--password"),e=0;e<i.length;e++){var t=i[e];t.setAttribute("data-counter",e),t.querySelector("input").value=$utilitiesService.randPassword(5,2,2),t.querySelector(".f1t-form-field__generate").addEventListener("click",function(e){e.preventDefault();var t=e.target.closest(".f1t-form-field--password").getAttribute("data-counter");i[t].querySelector("input").value=$utilitiesService.randPassword(5,2,2)}),t.querySelector(".f1t-form-field__toggle").addEventListener("click",function(e){e.preventDefault();var t=e.target.closest(".f1t-form-field--password").getAttribute("data-counter");"text"===i[t].querySelector("input").getAttribute("type")?i[t].querySelector("input").setAttribute("type","password"):i[t].querySelector("input").setAttribute("type","text"),e.target.classList.toggle("f1t-form-field__toggle--active")})}var r=document.querySelectorAll('.f1t-form-field--checkbox input[type="checkbox"]');for(e=0;e<r.length;e++){var a=r[e],n=a.closest(".f1t-form-field--checkbox").querySelector("input[name]");n.setAttribute("value",a.checked),a.addEventListener("change",function(e){n.setAttribute("value",a.checked)})}var o=document.querySelectorAll(".f1t-form-field--phone .f1t-form-field__input"),l=[];for(e=0;e<o.length;e++){var s=intlTelInput(o[e],{initialCountry:"auto",autoHideDialCode:!0,separateDialCode:!0});l.push(s),o[e].setAttribute("data-counter",e)}window.phoneFieldEls=o,window.itis=l;for(e=0;e<o.length;e++){var c=function(e){for(var t=e.target.getAttribute("data-counter"),i=$utilitiesService.domTools.closest(window.phoneFieldEls[t],"f1t-form-field--phone").querySelectorAll('input[type="hidden"]'),r=0;r<i.length;r++)i[r].setAttribute("value",window.itis[t].getNumber())};o[e].addEventListener("input",c),o[e].addEventListener("change",c),o[e].addEventListener("countrychange",c)}$geoService.doWhenIsReady(function(){for(var e=0;e<window.itis.length;e++)window.itis[e].telInput&&window.itis[e].telInput.defaultValue||$geoService.geo()&&$geoService.geo().iso_code&&window.itis[e].setCountry(String($geoService.geo().iso_code).toLowerCase())})},FormCommand.prototype._renderFormField=function(e,t){var i=document.createElement("div");i.classList.add("f1t-form__row");var r=document.createElement("div");switch(r.classList.add("f1t-form-field"),t.type){case"password":r.style.display="none",r.classList.add("f1t-form-field--password"),r.innerHTML='                <label>                    <div class="f1t-form-field__label">'+t.label+'</div>                    <div class="f1t-form-field__inner">                        <div class="f1t-form-field__password">                            <input type="'+t.type+'" placeholder="'+t.placeholder+'" name="'+t.key+'" value="'+t.value+'">                            <div class="f1t-form-field__toggle"></div>                        </div>                        <div class="f1t-form-field__generate">'+$translateService.t("GENERATE_PASSWORD")+"</div>                    </div>                </label>            ";break;case"phone":r.classList.add("f1t-form-field--phone"),r.innerHTML='                <label>                    <div class="f1t-form-field__label">'+t.label+'</div>                    <input class="f1t-form-field__input" type="text" placeholder="'+t.placeholder+'" name="'+t.key+'_visible" value="'+t.value+'">                    <input type="hidden" name="'+t.key+'" value="'+t.value+'">                </label>            ';break;case"accepted":r.classList.add("f1t-form-field--checkbox"),r.innerHTML='                <label>                    <input type="hidden" name="'+t.key+'">                    <input type="checkbox"'+("true"===t.value?' checked="checked"':"")+'>                    <span class="f1t-form-field__label">'+t.label+"</span>                </label>            ";break;default:r.innerHTML='                <label>                    <div class="f1t-form-field__label">'+t.label+'</div>                    <input type="'+t.type+'" placeholder="'+t.placeholder+'" name="'+t.key+'" value="'+t.value+'">                </label>            '}i.appendChild(r),e.appendChild(i)},FormValidationErrorsCommand.prototype._init=function(){var e=this;$utilitiesService.domReady(function(){$translateService.doWhenIsReady(function(){e._render()})})},FormValidationErrorsCommand.prototype._render=function(){this._formEl.classList.remove("f1t-form--loading");for(var e=this._formEl.querySelectorAll(".f1t-form-field--error"),t=0;t<e.length;t++)e[t].classList.remove("f1t-form-field--error");e=this._formEl.querySelectorAll(".f1t-form-field__error");for(t=0;t<e.length;t++)e[t].remove();for(var i in this._config){var r=this._formEl.querySelector("[name="+i+"]").parentElement;r.classList.add("f1t-form-field--error");var a=document.createElement("div");a.classList.add("f1t-form-field__error");for(t=0;t<this._config[i].length;t++)a.innerHTML+=$translateService.t(this._config[i][t]),t<this._config[i].length&&(a.innerHTML+=" ");r.appendChild(a)}},RedirectCommand.prototype._init=function(){var e=this;$utilitiesService.domReady(function(){e._render()})},RedirectCommand.prototype._render=function(){var e=new Url(this._config.url);if("GET"===this._config.method){for(var t in this._config.query)this._config.query.hasOwnProperty(t)&&(e.query[t]=this._config.query[t]);window.top.location.href=e.toString()}if("POST"===this._config.method){var i=document.createElement("form");for(var t in i.style.display="none",i.setAttribute("method","POST"),i.setAttribute("action",e.toString()),this._config.query)if(this._config.query.hasOwnProperty(t)){var r=document.createElement("input");r.setAttribute("type","hidden"),r.setAttribute("name",t),r.setAttribute("value",this._config.query[t]),i.appendChild(r)}document.body.appendChild(i),i.submit()}},TrafficFilterCommand.prototype._init=function(){var e=this;$utilitiesService.domReady(function(){$translateService.doWhenIsReady(function(){e._render()})})},TrafficFilterCommand.prototype._render=function(){var e=document.createElement("div");e.classList.add("f1t-modal"),e.classList.add("f1t-modal--small"),e.classList.add("f1t-modal--error"),e.innerHTML='      <div class="f1t-modal__wrapper">        <div class="f1t-modal__inner">          <div class="f1t-modal__header">            <div class="f1t-modal__image f1t-modal__image--error"></div>            <div class="f1t-modal__title">'+$translateService.t("TRAFFIC_BLOCK_TITLE")+'</div>            <div class="f1t-modal__subtitle">'+$translateService.t("TRAFFIC_BLOCK_SUBTITLE")+"</div>          </div>        </div>      </div>    ",document.body.appendChild(e)},PixelCommand.prototype._init=function(){this._render()},PixelCommand.prototype._render=function(){var self=this,pixels=self._config.pixels,loadedPixels=0,callback=function(){++loadedPixels===pixels.length&&self._callback()};0===pixels.length&&self._callback();for(var i=0;i<pixels.length;i++){var pixel=pixels[i];switch(pixel.type){case self._availablePixelTypes.inlineIframeUrl:var inlineIframeEl=document.createElement("iframe");inlineIframeEl.style.display="none",inlineIframeEl.setAttribute("data-type","f1t-pxl-inline-iframe-url"),inlineIframeEl.setAttribute("src",pixel.config),inlineIframeEl.addEventListener("load",callback),setTimeout(callback,1e3),document.body.appendChild(inlineIframeEl);break;case self._availablePixelTypes.inlineImgUrl:var inlineImgEl=document.createElement("img");inlineImgEl.style.display="none",inlineImgEl.setAttribute("data-type","f1t-pxl-inline-img-url"),inlineImgEl.setAttribute("src",pixel.config),inlineImgEl.addEventListener("load",callback),setTimeout(callback,1e3),document.body.appendChild(inlineImgEl);break;case self._availablePixelTypes.inlineScriptUrl:var inlineScriptEl=document.createElement("script");inlineScriptEl.setAttribute("data-type","f1t-pxl-inline-script-url"),inlineScriptEl.setAttribute("src",pixel.config),inlineScriptEl.addEventListener("load",callback),setTimeout(callback,1e3),document.head.appendChild(inlineScriptEl);break;case self._availablePixelTypes.externalIframeUrl:var externalIframeEl=document.createElement("iframe");externalIframeEl.style.display="none",externalIframeEl.setAttribute("data-type","f1t-pxl-external-iframe-url"),externalIframeEl.setAttribute("src",pixel.config),externalIframeEl.addEventListener("load",callback),setTimeout(callback,1e3),document.body.appendChild(externalIframeEl);break;case self._availablePixelTypes.externalSandboxIframeUrl:var externalSandboxIframeEl=document.createElement("iframe");externalSandboxIframeEl.style.display="none",externalSandboxIframeEl.setAttribute("data-type","f1t-pxl-external-sandbox-iframe-url"),externalSandboxIframeEl.setAttribute("src",pixel.config),externalSandboxIframeEl.setAttribute("sandbox","allow-scripts allow-same-origin"),externalSandboxIframeEl.addEventListener("load",callback),setTimeout(callback,1e3),document.body.appendChild(externalSandboxIframeEl);break;case self._availablePixelTypes.inlineSandboxIframeUrl:var inlineSandboxIframeEl=document.createElement("iframe");inlineSandboxIframeEl.style.display="none",inlineSandboxIframeEl.setAttribute("data-type","f1t-pxl-inline-sandbox-iframe-url"),inlineSandboxIframeEl.setAttribute("src",pixel.config),inlineSandboxIframeEl.setAttribute("sandbox","allow-scripts allow-same-origin"),inlineSandboxIframeEl.addEventListener("load",callback),setTimeout(callback,1e3),document.body.appendChild(inlineSandboxIframeEl);break;case self._availablePixelTypes.externalScriptUrl:var externalScriptEl=document.createElement("script");externalScriptEl.setAttribute("data-type","f1t-pxl-external-script-url"),externalScriptEl.setAttribute("src",pixel.config),externalScriptEl.addEventListener("load",callback),setTimeout(callback,1e3),document.head.appendChild(externalScriptEl);break;case self._availablePixelTypes.bodyHtmlInsert:var htmlInsertEl=document.createElement("div");htmlInsertEl.style.display="none",htmlInsertEl.classList.add("f1t-pxl-body-html-insert"),htmlInsertEl.innerHTML=pixel.config,document.body.appendChild(htmlInsertEl),callback();break;case self._availablePixelTypes.scriptEvaluate:try{eval(pixel.config),callback()}catch(e){Sentry&&Sentry.captureException(e),callback()}break;default:callback()}}},PrePushPixelsCommand.prototype._init=function(){var e=this;$utilitiesService.domReady(function(){$translateService.doWhenIsReady(function(){e._render(),new PixelCommand(this._config,function(){e._clearRender(),e._submitLast()})})})},PrePushPixelsCommand.prototype._render=function(){var e=document.createElement("div");e.classList.add("f1t-modal"),e.innerHTML='        <div class="f1t-modal__wrapper">            <div class="f1t-modal__inner">                <div class="f1t-modal__header">                    <div class="f1t-modal__title">'+$translateService.t("LOADING")+'</div>                    <div class="f1t-modal__subtitle">'+$translateService.t("REGISTERING")+"</div>                </div>            </div>        </div>    ",document.body.appendChild(e)},PrePushPixelsCommand.prototype._clearRender=function(){for(var e=document.querySelectorAll(".f1t-modal"),t=0;t<e.length;t++)e[t].remove()},PrePushPixelsCommand.prototype._submitLast=function(){var e=document.querySelectorAll(".f1t-form.is-submitted .f1t-form__wrapper")[0],t=document.createEvent("HTMLEvents");t.initEvent("submit",!0,!1),e&&e.dispatchEvent(t)},AdvAcceptedCommand.prototype._init=function(){var e=this;$utilitiesService.domReady(function(){$translateService.doWhenIsReady(function(){e._render()})})},AdvAcceptedCommand.prototype._render=function(){var e=document.createElement("div");e.classList.add("f1t-modal"),e.innerHTML='        <div class="f1t-modal__wrapper">            <div class="f1t-modal__inner">                <div class="f1t-modal__header">                    <div class="f1t-modal__pretitle">'+$translateService.t("ADV_ACCEPTED_PRETITLE")+'</div>                    <div class="f1t-modal__title">'+$translateService.t("ADV_ACCEPTED_TITLE")+'</div>                    <div class="f1t-modal__subtitle">'+$translateService.t("ADV_ACCEPTED_SUBTITLE")+'</div>                </div>                <div class="f1t-modal__body">                    <div class="f1t-modal__row">                        <div class="f1t-modal__icon f1t-modal__icon--1"></div>                        <div class="f1t-modal__text">                            <h3>'+$translateService.t("ADV_ACCEPTED_FEATURE_1_TITLE")+"</h3>                            <p>"+$translateService.t("ADV_ACCEPTED_FEATURE_1_SUBTITLE")+'</p>                        </div>                    </div>                    <div class="f1t-modal__row">                        <div class="f1t-modal__icon f1t-modal__icon--2"></div>                        <div class="f1t-modal__text">                            <h3>'+$translateService.t("ADV_ACCEPTED_FEATURE_2_TITLE")+"</h3>                            <p>"+$translateService.t("ADV_ACCEPTED_FEATURE_2_SUBTITLE")+'</p>                        </div>                    </div>                </div>                <div class="f1t-modal__footer">                    <a class="f1t-modal__button f1t-detect-iframe" href="'+this._config.url+'" target="_top" title="'+$translateService.t("CLICK_TO_OPEN")+'">                    '+$translateService.t("ADV_ACCEPTED_SUBMIT")+"                    </a>                </div>            </div>        </div>    ",document.body.appendChild(e)},AdvAcceptedHtmlCommand.prototype._init=function(){var e=this;$utilitiesService.domReady(function(){$translateService.doWhenIsReady(function(){e._render()})})},AdvAcceptedHtmlCommand.prototype._render=function(){var e=document.createElement("div");e.classList.add("f1t-modal"),e.innerHTML='        <div class="f1t-modal__wrapper">            <div class="f1t-modal__inner">                <div class="f1t-modal__body">                    <div class="js-insert-html"></div>                <div class="f1t-modal__footer">                    <a class="f1t-modal__button f1t-detect-iframe" href="'+this._config.url+'" target="_top" title="'+$translateService.t("CLICK_TO_OPEN")+'">                    '+$translateService.t("ADV_ACCEPTED_SUBMIT")+"                    </a>                </div>            </div>        </div>    ",document.body.appendChild(e),this._afterRender()},AdvAcceptedHtmlCommand.prototype._afterRender=function(){for(var e=document.querySelectorAll(".js-insert-html"),t=0;t<e.length;t++)e[t].innerHTML=this._config.settings.HTML},AdvAcceptedPasswordCommand.prototype._init=function(){var e=this;$utilitiesService.domReady(function(){$translateService.doWhenIsReady(function(){e._render()})})},AdvAcceptedPasswordCommand.prototype._render=function(){var e=document.createElement("div");e.classList.add("f1t-modal"),e.innerHTML='        <div class="f1t-modal__wrapper">            <div class="f1t-modal__inner">                <div class="f1t-modal__header">                    <div class="f1t-modal__pretitle">'+$translateService.t("ADV_ACCEPTED_PRETITLE")+'</div>                    <div class="f1t-modal__title">'+$translateService.t("ADV_ACCEPTED_TITLE")+'</div>                    <div class="f1t-modal__subtitle">'+$translateService.t("ADV_ACCEPTED_SUBTITLE")+'</div>                </div>                <div class="f1t-modal__body">                    <div class="f1t-modal__row">                        <div class="f1t-modal__card">                            <div class="f1t-modal__field">                                <div class="f1t-modal__key">'+$translateService.t("YOUR_LOGIN")+':</div>                                <div class="f1t-modal__value js-click-to-copy" title="'+$translateService.t("CLICK_TO_COPY")+'">'+this._config.login+'</div>                            </div>                            <div class="f1t-modal__field">                                <div class="f1t-modal__key">'+$translateService.t("YOUR_PASSWORD")+':</div>                                <div class="f1t-modal__value js-click-to-copy" title="'+$translateService.t("CLICK_TO_COPY")+'">'+this._config.password+'</div>                            </div>                        </div>                    </div>                    <div class="f1t-modal__row">                        <div class="f1t-modal__icon f1t-modal__icon--1"></div>                        <div class="f1t-modal__text">                            <h3>'+$translateService.t("ADV_ACCEPTED_FEATURE_1_TITLE")+"</h3>                            <p>"+$translateService.t("ADV_ACCEPTED_FEATURE_1_SUBTITLE")+'</p>                        </div>                    </div>                    <div class="f1t-modal__row">                        <div class="f1t-modal__icon f1t-modal__icon--2"></div>                        <div class="f1t-modal__text">                            <h3>'+$translateService.t("ADV_ACCEPTED_FEATURE_2_TITLE")+"</h3>                            <p>"+$translateService.t("ADV_ACCEPTED_FEATURE_2_SUBTITLE")+'</p>                        </div>                    </div>                </div>                <div class="f1t-modal__footer">                    <a class="f1t-modal__button js-open-iframe" href="#." title="'+$translateService.t("CLICK_TO_OPEN")+'">                    '+$translateService.t("ADV_ACCEPTED_SUBMIT")+"                    </a>                </div>            </div>        </div>    ",document.body.appendChild(e),this._afterRender()},AdvAcceptedPasswordCommand.prototype._afterRender=function(){var e=document.querySelectorAll(".js-click-to-copy"),t=this;e.forEach(function(t){t.addEventListener("click",function(){t.classList.add("is-selected");var e=document.createElement("input");e.style.position="absolute",e.style.opacity="0",e.style.zIndex="-1",document.body.appendChild(e),e.value=t.innerHTML,e.focus(),e.select(),document.execCommand("copy"),setTimeout(function(){t.classList.remove("is-selected"),e.remove()},200)})}),document.querySelectorAll(".js-open-iframe").forEach(function(e){e.addEventListener("click",function(e){e.preventDefault(),t._renderIframe()})}),document.querySelectorAll(".js-close-iframe").forEach(function(e){e.addEventListener("click",function(e){e.preventDefault(),document.querySelectorAll(".f1t-iframe-modal").forEach(function(e){e.remove()})})}),document.querySelectorAll(".js-click-to-redirect").forEach(function(e){e.addEventListener("click",function(e){e.preventDefault(),window.top.location.href=t._config.url})})},AdvAcceptedPasswordCommand.prototype._renderIframe=function(){var e=document.createElement("div");e.classList.add("f1t-iframe-modal"),e.innerHTML='        <div class="f1t-iframe-modal__wrapper">            <div class="f1t-iframe-modal__close js-click-to-redirect" title="'+$translateService.t("CLICK_TO_CLOSE")+'"></div>            <div class="f1t-iframe-modal__inner">                <iframe src="'+this._config.url+'" class="f1t-iframe"></iframe>            </div>            <div class="f1t-iframe-modal__footer">                <div class="f1t-iframe-modal__row">                    <div class="f1t-iframe-modal__col">                        <div class="f1t-iframe-modal__field">                            <div class="f1t-iframe-modal__icon">                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">                                <path d="M15.8551 6.35419C15.8551 8.47848 14.1252 10.2084 12.0009 10.2084C9.8765 10.2084 8.14667 8.47848 8.14667 6.35419C8.14667 4.22989 9.8765 2.5 12.0009 2.5C14.1252 2.5 15.8551 4.2299 15.8551 6.35419Z" fill="#0FAF59" stroke="#0FAF59" stroke-width="2"/>                                <path d="M19.8282 21.9002H4.17177C4.07693 21.9002 4 21.8233 4 21.7285C4 17.3181 7.58973 13.7285 12 13.7285C16.4103 13.7285 20 17.3181 20 21.7285C20 21.8233 19.9231 21.9002 19.8282 21.9002Z" fill="#0FAF59" stroke="#0FAF59" stroke-width="2"/>                                </svg>                            </div>                            <div class="f1t-iframe-modal__key">'+$translateService.t("YOUR_LOGIN")+':</div>                            <div class="f1t-iframe-modal__value js-click-to-copy" title="'+$translateService.t("CLICK_TO_COPY")+'">'+this._config.login+'</div>                        </div>                    </div>                    <div class="f1t-iframe-modal__col">                        <div class="f1t-iframe-modal__field">                            <div class="f1t-iframe-modal__icon">                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">                                <path d="M20.5 9H19V6.99998C19 3.14016 15.8599 0 12 0C8.14012 0 5.00002 3.14016 5.00002 6.99998V9H3.50002C3.22364 9 3 9.22364 3 9.50002V22C3 23.103 3.89695 24 5.00002 24H19C20.103 24 21 23.103 21 22V9.50002C21 9.22364 20.7764 9 20.5 9ZM13.4971 19.4448C13.5127 19.5859 13.4673 19.7275 13.3726 19.8335C13.2779 19.9395 13.1421 20 13 20H11C10.8579 20 10.7222 19.9395 10.6275 19.8335C10.5327 19.7276 10.4873 19.586 10.503 19.4448L10.8184 16.6084C10.3062 16.2359 10 15.6465 10 15C10 13.897 10.897 13 12 13C13.1031 13 14.0001 13.8969 14.0001 15C14.0001 15.6465 13.6939 16.2359 13.1817 16.6084L13.4971 19.4448ZM16 9H8.00002V6.99998C8.00002 4.79442 9.79444 3 12 3C14.2056 3 16 4.79442 16 6.99998V9Z" fill="#0FAF59"/>                                </svg>                            </div>                            <div class="f1t-iframe-modal__key">'+$translateService.t("YOUR_PASSWORD")+':</div>                            <div class="f1t-iframe-modal__value js-click-to-copy" title="'+$translateService.t("CLICK_TO_COPY")+'">'+this._config.password+'</div>                        </div>                    </div>                    <div class="f1t-iframe-modal__col">                        <a href="'+this._config.url+'" target="_blank" class="f1t-iframe-modal__button js-click-to-redirect" title="'+$translateService.t("CLICK_TO_CLOSE")+'">'+$translateService.t("CLOSE")+"</a>                    </div>                </div>            </div>        </div>    ",document.body.appendChild(e),this._afterRender()},AutoRedirectModal.prototype._init=function(){var e=this;$utilitiesService.domReady(function(){$translateService.doWhenIsReady(function(){e._render()})})},AutoRedirectModal.prototype._render=function(){var e=document.createElement("div");e.classList.add("f1t-modal"),e.innerHTML='        <div class="f1t-modal__wrapper">            <div class="f1t-modal__inner">                <div class="f1t-modal__header">                    <div class="f1t-modal__pretitle">'+$translateService.t("ADV_ACCEPTED_PRETITLE")+'</div>                    <div class="f1t-modal__title">'+$translateService.t("ADV_ACCEPTED_TITLE")+'</div>                    <div class="f1t-modal__subtitle">'+$translateService.t("ADV_ACCEPTED_SUBTITLE")+'</div>                </div>                <div class="f1t-modal__body">                    <div class="f1t-modal__row">                        <div class="f1t-modal__icon f1t-modal__icon--1"></div>                        <div class="f1t-modal__text">                            <h3>'+$translateService.t("ADV_ACCEPTED_FEATURE_1_TITLE")+"</h3>                            <p>"+$translateService.t("ADV_ACCEPTED_FEATURE_1_SUBTITLE")+'</p>                        </div>                    </div>                    <div class="f1t-modal__row">                        <div class="f1t-modal__icon f1t-modal__icon--2"></div>                        <div class="f1t-modal__text">                            <h3>'+$translateService.t("ADV_ACCEPTED_FEATURE_2_TITLE")+"</h3>                            <p>"+$translateService.t("ADV_ACCEPTED_FEATURE_2_SUBTITLE")+'</p>                        </div>                    </div>                </div>                <div class="f1t-modal__footer">                    <a class="f1t-modal__button f1t-detect-iframe " href="'+this._config.url+'" target="_top" title="'+$translateService.t("CLICK_TO_OPEN")+'">                    '+$translateService.t("ADV_ACCEPTED_SUBMIT")+'                    <span class="f1t-countdown-redirect" data-href="'+this._config.url+'"></span></a>                </div>            </div>        </div>    ',document.body.appendChild(e),document.querySelectorAll(".f1t-countdown-redirect").forEach(function(i){console.log(i.getAttribute("data-href"));var r=5;setInterval(function(){var e=r%60,t=(r-e)/60;1==e.toString().length&&(e="0"+e),1==t.toString().length&&(t="0"+t),i.innerHTML=t+":"+e,0==--r&&(window.top.location.href=i.getAttribute("data-href"))},1e3)})},AdvDeclinedCommand.prototype._init=function(){var e=this;$utilitiesService.domReady(function(){$translateService.doWhenIsReady(function(){e._render()})})},AdvDeclinedCommand.prototype._render=function(){var e=document.createElement("div");e.classList.add("f1t-modal"),e.classList.add("f1t-modal--error"),e.innerHTML='        <div class="f1t-modal__wrapper">            <div class="f1t-modal__inner">                <div class="f1t-modal__header">                    <div class="f1t-modal__image f1t-modal__image--error"></div>                    <div class="f1t-modal__title">'+$translateService.t("ADV_DECLINE_TITLE")+'</div>                    <div class="f1t-modal__subtitle">'+$translateService.t("ADV_DECLINE_SUBTITLE")+'</div>                </div>                <div class="f1t-modal__footer">                    <div class="f1t-modal__button js-try-again">'+$translateService.t("TRY_AGAIN")+"</div>                   </div>            </div>        </div>    ",document.body.appendChild(e),this._afterRender()},AdvDeclinedCommand.prototype._afterRender=function(){for(var t=this,e=document.querySelectorAll(".js-try-again"),i=0;i<e.length;i++)e[i].addEventListener("click",function(e){e.preventDefault(),t._reInit()})},AdvDeclinedCommand.prototype._reInit=function(){$workflowService.reInitForm()},ThankYouCommand.prototype._init=function(){var e=this;$utilitiesService.domReady(function(){e._render()})},ThankYouCommand.prototype._render=function(){$workflowService.skipFutureCommands=!0,window.top.location.href=this._config.settings.THANK_YOU_URL},ThankYouRedirectCommand.prototype._init=function(){var e=this;$utilitiesService.domReady(function(){e._render()})},ThankYouRedirectCommand.prototype._render=function(){var e=new Url(this._config.settings.THANK_YOU_URL+window.location.search);e.query._delayedRedirects="yes",e.query._rawRedirectUrl=this._config.url,this._config.settings.hasOwnProperty("REDIRECT_URL")&&(e.query._rawRedirectUrl=this._config.settings.REDIRECT_URL),$workflowService.skipFutureCommands=!0,window.top.location.href=e.toString()},WorkflowService.prototype._init=function(){return $utilitiesService.getData()?$configService.checkConfig()&&$configService.isAvailableInit()?void this._standaloneInit():void this._reInit():$configService.isAvailableInit()?void this._standaloneInit():void this._emptyInit()},WorkflowService.prototype._standaloneInit=function(){var i=this,e=new Url($configService.initUrl());$utilitiesService.getParameterByName("tp_aff_sub")&&(e.query.tp_aff_sub=$utilitiesService.getParameterByName("tp_aff_sub"));for(var t=0;t<50;t++)$utilitiesService.getParameterByName("tp_aff_sub"+(t+1))&&(e.query["tp_aff_sub"+(t+1)]=$utilitiesService.getParameterByName("tp_aff_sub"+(t+1)));$utilitiesService.getParameterByName("tp_offer_id")&&(e.query.tp_offer_id=$utilitiesService.getParameterByName("tp_offer_id")),$utilitiesService.getParameterByName("tp_affiliate_id")&&(e.query.tp_affiliate_id=$utilitiesService.getParameterByName("tp_affiliate_id")),$utilitiesService.getParameterByName("ld_id")&&(e.query.ld_id=$utilitiesService.getParameterByName("ld_id")),$utilitiesService.getParameterByName("ts_id")&&(e.query.ts_id=$utilitiesService.getParameterByName("ts_id")),$configService.localApi()||(e.host=$utilitiesService.getParameterByName("ld_id")+$configService.localSuffix(),e.port="",e.protocol="https"),e.query.e=$configService.encodedParams(),$utilitiesService.http("GET",e,function(e){var t=new Url;$storeService.set("funnelUrl",t.toString()),$utilitiesService.setData(JSON.parse(e).d),i._init()})},WorkflowService.prototype._emptyInit=function(){var e=this;$translateService.doWhenIsReady(function(){e.onState({commands:[{type:"form",config:{fields:[{type:"text",label:$translateService.t("First Name"),key:"fname",placeholder:$translateService.t("Please enter your first name"),value:"",validation_rules:""},{type:"text",label:$translateService.t("Last Name"),key:"lname",placeholder:$translateService.t("Please enter your last name"),value:"",validation_rules:""},{type:"email",label:$translateService.t("Email"),key:"email",placeholder:$translateService.t("Please enter your actual email"),value:"",validation_rules:""}],submit:$translateService.t("SUBMIT_FORM")}}]})})},WorkflowService.prototype.reInitForm=function(){var i=this;this.clear(),this.onState({commands:[{type:"loading"}]});var e=$configService.apiUrl()+"/api/v1/leads-workflow/forms/handle?e="+$configService.encodedParams()+"&ld_id="+$configService.apiDomain()+"&id="+$utilitiesService.getData().id;$utilitiesService.http("GET",e,function(e){var t;try{t=JSON.parse(e).data}catch(e){t={commands:[{type:"loading"}]}}if(i.onState(t),window!==window.parent)try{window.top.postMessage({source:"irv-iframe",href:window.location.href},"*")}catch(e){}})},WorkflowService.prototype._reInit=function(){var i=this;this.onState({commands:[{type:"loading"}]});var e=$configService.apiUrl()+"/api/v1/leads-workflow/forms/onStateEnter?e="+$configService.encodedParams()+"&ld_id="+$configService.apiDomain()+"&id="+$utilitiesService.getData().id;try{var t=new Url(e);t.query.referer=window.location.origin+window.location.pathname,e=t.toString()}catch(e){}$utilitiesService.http("GET",e,function(e){var t;try{t=JSON.parse(e).data}catch(e){t={commands:[{type:"loading"}]}}i.onState(t)})},WorkflowService.prototype.onState=function(e,t){var i=this;if(e){0===e.commands.length&&this._reInit(),e=this._sortOnState(e);var r=!1;"yes"===$utilitiesService.getParameterByName("_delayedRedirects")&&(window.delayedRedirectsTriggerFn=function(){window.location.href=$utilitiesService.getParameterByName("_rawRedirectUrl")});for(var a=0;a<e.commands.length;a++){if(r)return!1;if(i.skipFutureCommands)return!1;switch(e.commands[a].type){case"loading":new LoadingCommand;break;case"verification":new VerificationCommand;break;case"verification-fail":new VerificationCommand(!0);break;case"form":new FormCommand(e.commands[a].config);break;case"form-validation-errors":new FormValidationErrorsCommand(e.commands[a].config,t);break;case"adv-declined":new AdvDeclinedCommand;break;case"thank-you":new ThankYouCommand(e.commands[a].config);break;case"thank-you-redirect":new ThankYouRedirectCommand(e.commands[a].config);break;case"adv-accepted":new AdvAcceptedCommand(e.commands[a].config);break;case"modal-html":new AdvAcceptedHtmlCommand(e.commands[a].config);break;case"auto-redirect-modal":new AutoRedirectModal(e.commands[a].config);break;case"adv-accepted-iframe-with-login-password":new AdvAcceptedPasswordCommand(e.commands[a].config);break;case"redirect":new RedirectCommand(e.commands[a].config);break;case"pre-push-pixels":new PrePushPixelsCommand(e.commands[a].config);break;case"traffic-filter":new TrafficFilterCommand;break;case"reset":new ResetCommand;break;case"pixels":if(0===e.commands[a].config.pixels.length)break;r=!0;var n=JSON.parse(JSON.stringify(e));n.commands.splice(0,a+1),new PixelCommand(e.commands[a].config,function(){r=!1,i.onState(n,t)})}}}},WorkflowService.prototype._sortOnState=function(e){var t=JSON.parse(JSON.stringify(e));t.commands=[];for(var i=0;i<e.commands.length;i++)"pixels"===e.commands[i].type?t.commands.unshift(e.commands[i]):t.commands.push(e.commands[i]);return t},WorkflowService.prototype.clear=function(){for(var e=document.querySelectorAll(".f1t-modal"),t=0;t<e.length;t++)e[t].remove();var i=document.querySelectorAll(".f1t-iframe-pxl");for(t=0;t<i.length;t++)i[t].remove();var r=document.querySelectorAll(".f1t-iframe-modal");for(t=0;t<r.length;t++)r[t].remove()};var $workflowService=new WorkflowService;function CaptchaService(){this._isReady=!1,this._init()}CaptchaService.prototype.doWhenIsReady=function(e){this._isReady?e():$eventBusService.on("captchaService:ready",e)},CaptchaService.prototype._init=function(){try{this.doWhenIsReady(function(){"undefined"!=typeof grecaptcha&&grecaptcha.ready(function(){$utilitiesService.doWhenIsReady(function(){void 0!==$utilitiesService.getData()&&grecaptcha.execute("6LcUjmoaAAAAADy6tjOg7FafQwMLUFEx4xw-lhHc",{action:"homepage"}).then(function(e){var t=$configService.apiUrl()+"/api/v1/leads-workflow/forms/score?e="+$configService.encodedParams()+"&token="+e+"&ld_id="+$configService.apiDomain()+"&id="+$utilitiesService.getData().id;$utilitiesService.http("GET",t,function(){})});var e=0,t=setInterval(function(){void 0!==$utilitiesService.getData()?9<=e?clearInterval(t):(e++,grecaptcha.execute("6LcUjmoaAAAAADy6tjOg7FafQwMLUFEx4xw-lhHc",{action:"homepage"}).then(function(e){var t=$configService.apiUrl()+"/api/v1/leads-workflow/forms/score?e="+$configService.encodedParams()+"&token="+e+"&ld_id="+$configService.apiDomain()+"&id="+$utilitiesService.getData().id;$utilitiesService.http("GET",t,function(){})})):clearInterval(t)},5e3)})})})}catch(e){window.console&&console.error(e),Sentry&&Sentry.captureException(e)}};var $captchaService=new CaptchaService;function f1tRecaptchaCallback(){$captchaService._isReady=!0,$eventBusService.emit("captchaService:ready")}